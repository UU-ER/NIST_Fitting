function fit_nist_3 (name_data_nist_document,structure_name_characteristics,structure_name_TP,first_sorting,second_sorting,pCH4_1)
%========================================================
...
% (CH4) in a file (useful_data_nist.xml). CCDC data can be manually added.
%-------------------------------------------------------
...
%           - pCH4_1 Partial pressure of adsorption
...
%--- make plots ---
plots('R2_yes', 'characteristics_yes',dH_list, wc_list ,gamma_list, m0_list, q0_list, ns_equ_list, KH_list, list_of_R2,pCH4_1,[],[])
