...
clear all
initial_data  = "database_CH4_DOIs_modified_03082023.xml"; 
...
%     initial_data="database_100_DOIs_modified_03082023.xml";
    string_name_NIST_CHAR_1  = strcat("NIST_CHAR_DATA1_CH4_18072023",string(every_pressure),".xml");
    string_name_NIST_TP_1   = strcat("NIST_TP_DATA1_CH4_18072023",string(every_pressure),".xml");
...
%     string_name_NIST_CHAR_2 = strcat("NIST_CHAR_DATA2_CH4_18072023", string(every_pressure),".xml");
%     string_name_NIST_TP_2 = strcat("NIST_TP_DATA2_CH4_18072023", string(every_pressure),".xml");
