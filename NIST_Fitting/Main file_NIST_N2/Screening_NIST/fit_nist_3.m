function fit_nist_3 (name_data_nist_document,structure_name_characteristics,structure_name_TP,first_sorting,second_sorting,pN2_1)
%========================================================
...
% (N2) in a file (useful_data_nist.xml). CCDC data can be manually added.
%-------------------------------------------------------
...
%           - pN2_1 Partial pressure of adsorption
...
%---SETTINGS---
plot_isotherms = "yes";  %plotting all isotherms
...
if second_sorting == "yes"
    ...
    for every_gas = 2 %Only CO2=1 N2=2, CH4=3, 
        if first_sorting =="yes"
...
%--- make plots ---
plots('R2_yes', 'characteristics_yes',dH_list, wc_list ,gamma_list, m0_list, q0_list, ns_equ_list, KH_list, list_of_R2,pN2_1,[],[])
