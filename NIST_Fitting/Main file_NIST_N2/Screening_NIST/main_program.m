...
clear all
initial_data  = "database_100_DOIs.xml"; 
% initial_data  = "database_N2_DOIs_modified_08082023_v3.xml"; 
...
%     initial_data="database_100_DOIs_modified_03082023.xml";
    string_name_NIST_CHAR_1  = strcat("NIST_CHAR_DATA1_N2_07082023",string(every_pressure),".xml");
    string_name_NIST_TP_1   = strcat("NIST_TP_DATA1_N2_07082023",string(every_pressure),".xml");
    ...
    string_name_NIST_CHAR_2 = strcat("NIST_CHAR_DATA2_N2_07082023", string(every_pressure),".xml");
    string_name_NIST_TP_2 = strcat("NIST_TP_DATA2_N2_07082023", string(every_pressure),".xml");
