...
% (CH4) in a file (name_to_save). CCDC data can be manually added.
%-------------------------------------------------------
...
%             saved.
%Program:   Opens all data in biography that inlcudes daya on CH4 adsorbents,
%           opens the ones that are adsorbents for CH4. 
...
%            all academic works that measured isotherm of at least one CH4 adsorbent
...
data_is_useful = 1;
        for i = [1:i_max] 
           ...
           while data_is_useful == 1  %this loop is broken if data is not CH4 specific/not present in CCDC data
